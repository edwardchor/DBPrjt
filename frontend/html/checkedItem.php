			...
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12">
						<div id="gtco-logo"><a href="index.html">NYU Library <em>.</em></a></div>
					</div>
					...
					<div class="col-xs-8 text-right menu-1">
						<ul>
							<input type="text" class="'col-xs-8 col-xs-offset-1" id="searchContent">
							<li class="btn-cta" id="searchButtom" onclick="search(this)"><a ><span>SEARCH</span></a></li>
						</ul>
						<script>
